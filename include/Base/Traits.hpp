...
template<class T>
struct is_scalar {
	static const bool value = is_scalar<T>::value || is_complex<T>::value;
};
//%}
...
struct data_object: copt_object {
};
// the data object
struct referred_array: data_object {
};
// refered array
struct array_object: data_object {
};
// array
struct matrix_object: data_object {
};
// normal matrix
struct vector_object: data_object {
};
// normal vector
struct sp_matrix_object: data_object {
};
// sparse matrix

/** function objects */
struct scalar_func_object: copt_object {
};
// scalar function
struct vector_func_object: copt_object {
};
// vector function

/** problem object */
struct problem_object: copt_object {
};
// problem
struct linear_programming: problem_object {
};
struct lasso_problem: problem_object {
};
// lasso problem

/** solver for problems */
struct solver_object: copt_object {
};
// solver
struct linear_solver: solver_object {
};
// linear solver
struct admm_solver: solver_object {
};
// admm solver
struct proximal_solver: solver_object {
};
// proximal solver
struct fista_solver: solver_object {
};
// FISTA solver

/** constraint objects */
struct constraint_object: copt_object {
};
// constraint

/** no time statistics tag */
struct time_stat_object: copt_object {
};
